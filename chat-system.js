...
(function(){
  ...
  function addStyles(){
    ...
    const s=document.createElement('style'); s.id='aq-chat-v2-style'; s.textContent=`
      ...
      .aq-thinking-link{display:flex;align-items:center;gap:14px;width:calc(100% - 36px);margin:15px 18px 0;padding:12px 16px;min-height:76px;border:1px solid #ffffff28;border-radius:19px;background:linear-gradient(135deg,#173f3b,#0c2d2e);color:#fff;cursor:pointer;text-align:left;box-shadow:inset 0 1px #fff2,0 10px 24px #0005;font:inherit}
      .aq-thinking-link:active{transform:scale(.985)}
      .aq-thinking-link .aq-thinking-icon{font-size:34px}
      .aq-thinking-link b{display:block;font-size:19px}.aq-thinking-link span{display:block;color:#ddd8d0;font-size:12px;margin-top:2px}.aq-thinking-link .aq-thinking-arrow{margin-left:auto;font-size:30px;color:#e8d58e}
  ...
  function watch(){bindChatOpenButtons();addThinkingLink();if(setup())return;setTimeout(watch,300)}
